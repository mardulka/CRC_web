    ...
    <x-element.content-box>
        ...
        <x-tabs.content id="RaceTab">
            <x-tabs.content-item id="information">
                ...
                <x-card-field.named heading="Tréninky a kvalifikace">
                    @foreach($practices as $practice)
                        <x-card.race-subevent name="{{$practice->name}}" date="{{ date('d.m.Y' ,strtotime($practice->date)) }}"
                                         link="{{route('practice', ['id' => $practice->practice_id])}}" time="{{$practice->time}}" />
                    @endforeach
                    @foreach($qualifications as $qualification)
                        <x-card.race-subevent name="{{$qualification->name}}" date="{{ date('d.m.Y' ,strtotime($qualification->date)) }}"
                                         link="{{route('practice', ['id' => $qualification->qualification_id])}}" time="{{$qualification->time}}" />
                    @endforeach
                </x-card-field.named>
